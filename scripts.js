...
//Captura o evento de submit do formalário para obter os valores.
form.onsubmit = (event) => {
  ...
  //Chame a função que ira adicionar um item na lista
...
function expenseAdd(newExpense) {
  try {
    ...
    //Adiciona name e category em expanse info
...
function updateTotals() {
  try {
    ...
    //Formata o valor e remove o R$ que será exibido pela small com um estilo css
